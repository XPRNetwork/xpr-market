...
const LearnMoreCard = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <Card>
        <CardTitle>How to get started on Proton Market</CardTitle>
        <CardParagraph>
          Our ground-breaking NFT marketplace has been one of the community’s
          favorite projects to come from the Proton team in recent months.
          Proton Market, the world’s easiest to use NFT platform, has allowed
          people to upload an NFT with just a few clicks, buy and sell NFTs for
          just a few cents in fees, and earn royalties on resales of their
          creations passively and stress-free.
        </CardParagraph>
        <CardParagraph>Here’s how to get started:</CardParagraph>
        <CardParagraph>
          Step 1 - Create a <u>Proton Wallet account</u> for free.
        </CardParagraph>
        <CardParagraph>
          Step 2 - Visit{' '}
          <StandardLink
        ...
        <CardParagraph>
          ...
          collection, uploading a file, and choosing all of the related options.
        </CardParagraph>
        <CardParagraph>
          Step 4 - Spread the word about your NFT on social media to increase
      ...
      <Card>
        ...
        <CardParagraph>
          <strong>We firmly believe that whatever can be decentralized;</strong>{' '}
          should be decentralized; cryptocurrency is best when more people can
          exert small amounts of collective control, and this logic applies to
          our own projects as well. For this reason,{' '}
          <u>we made the code behind Proton Market open source</u> – meaning
          anyone can integrate Proton Market into their own website without
          needing to ask permission.
        </CardParagraph>
        <CardParagraph>
          To build on this momentum, we have also released an interactive
          version of Proton Market. With this, creators can not only integrate
          the Proton Market platform into their own website, but they can also
          change the way that it looks and feels so that it matches their
          overall style. By making our marketplace template interactive,
          creators can now change how Proton Market looks when it’s on their
          website - from the font on the headings down to the text on the
          buttons.
        </CardParagraph>
        <CardParagraph>
        ...
        <CardParagraph>
          Step 1 - Visit the open-source codebase is available on Github here:{' '}
          <StandardLink
            target="_BLANK"
            rel="noreferrer"
        ...
        <CardParagraph>
          Step 3 - View the written text and language that can be edited in the
          file “localization.ts” (located here{' '}
          <StandardLink
            target="_BLANK"
            rel="noreferrer"
        ...
        <CardParagraph>
          Step 4 - Check out more of the exact details here to see how all of
          this will look as you’re working on it:{' '}
          <StandardLink
            target="_BLANK"
            rel="noreferrer"
      ...
      <Card>
        <CardTitle>Frequently Asked Questions about Proton Market</CardTitle>
        <Question>What type of files are supported on Proton Market?</Question>
        <Answer>PNG, GIF, JPG, WEBP, and MP4</Answer>
        <Question>How does key management work?</Question>
        <Answer>
          Proton Wallet is a non-custodial wallet, meaning every user manages
        ...
        <Answer>
          No, we currently do not allow direct purchasing of NFTs using a credit
